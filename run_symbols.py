...
def main(out_path: str = "symbols_results.json"):
    ...
    _t = np.zeros((112, 112), np.uint8)
    _t[30, 20:92] = 1
    _t[30:92, 56] = 1
    _l = np.zeros((112, 112), np.uint8)
    _l[56, 20:92] = 1
    _p = np.zeros((112, 112), np.uint8)
    _p[20:92, 40] = 1
    _p[20:92, 72] = 1
    checks = [
        (
            "circularity (O)",
            bresenham_circle(112, 56, 56, 30),
            dict(endpoints=0, t_junctions=0, x_junctions=0, holes=1),
        ),
        (
            "concentricity",
            np.maximum(bresenham_circle(112, 56, 56, 30), bresenham_circle(112, 56, 56, 18)),
