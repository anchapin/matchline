...
class TestReviewQueueBlocksExport:
    ...
    def test_confirmed_review_items_do_not_block_export(self):
        ...
        not block export even if needs_review=True and acknowledged=False -- the
        confirmed status itself indicates the item has been reviewed and resolved.
        """
        model = make_clean_model()
        model.review_queue.append(
            ReviewItem(
    ...
    def test_rejected_review_items_do_not_block_export(self):
        ...
        not block export even if needs_review=True and acknowledged=False -- the
        rejected status itself indicates the item has been reviewed and resolved.
        """
        model = make_clean_model()
        model.review_queue.append(
            ReviewItem(
